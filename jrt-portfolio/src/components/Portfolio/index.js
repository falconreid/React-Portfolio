...
function Portfolio() {
  ...
  {/* Portfolio Graphics & Links */}
           <div  className="row portfolioLinks">
             ...
             <div className="row portfolioLinks">
               <div className="col-md-6"><a href="https://falconreid.github.io/6-Weather-Dashboard-App/" target="_blank" rel="noreferrer"><img src="images/WeatherAppbtn.jpg" alt="Weather App" title="Weather App" /></a></div>
               <div className="col-md-6"><a href="https://falconreid.github.io/5-Work-Day-Scheduler/" target="_blank" rel="noreferrer"><img src="images/DigitalDaytimerbtn.jpg" alt="Digital Daytimer" title="Digital Daytimer" /></a></div>
               </div>
               ...
               <div className="row portfolioLinks">
                 ...
                 <div className="row portfolioLinks">
                   <div className="col-md-6"><a href="https://still-wildwood-87381.herokuapp.com/" target="_blank" rel="noreferrer"><img src="images/FitBytes-btn.jpg" alt=""/></a></div>
                   <div className="col-md-6"><a href="RockPaperScissors.html" title="Rock Paper Scissors Game" alt="Rock Paper Scissors Game" target="_blank" rel="noreferrer"><img src="images/RockPaperScissorsGame.jpg" alt=""/></a></div>
